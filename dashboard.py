...
# ==============================================================
import os
_CSV_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'cleaned_fuel_data.csv')
...
server = app.server  # needed so gunicorn / hosting platforms can find the Flask server
